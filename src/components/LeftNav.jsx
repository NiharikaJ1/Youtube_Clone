...
export default function LeftNav() {
  ...
  return (
    <div className={`md:block w-[240px] overflow-y-auto h-full py-4 bg-black absolute md:relative z-10 translate-x-[-240px] md:translate-x-0 transition-all scrollbar-thin scrollbar-thumb-rounded-md scrollbar-thumb-gray-400 scrollbar-track-black-100 ${
      mobileMenu ? "translate-x-0" : ""
  }`}>
      <div className="flex px-5 flex-col">
        {content}
        <hr className='my-5 border-white/[0.2]'></hr>
        <div className="text-white/[0.5] text-[12px]">Clone by: Niharika Joshi</div>
      </div>
    </div>
  )
}
